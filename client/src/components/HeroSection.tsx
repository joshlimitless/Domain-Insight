      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        ...
        <div className="flex flex-row items-center justify-center gap-4 mb-16">
          <Button 
            size="lg"
            onClick={onCtaClick}
            className="bg-gradient-to-r from-violet-500 to-fuchsia-500 border-0 text-white shadow-xl shadow-violet-500/30 gradient-outline pl-[16px] pr-[16px] font-bold"
